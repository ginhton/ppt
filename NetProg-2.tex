...
\subsubsection{\texttt{socket, connect, bind, listen, accept, close}}
\begin{frame}
...
\begin{frame}[containsverbatim]
  ...
  \begin{figure}
  \centering
  \includegraphics[width=.8\textwidth]{fig/f-socket-family.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  \begin{figure}
  \centering
  \includegraphics[width=.8\textwidth]{fig/f-socket-type.png}
  \includegraphics[width=.8\textwidth]{fig/f-socket-protocol.png}
  \end{figure}
\end{frame}

\begin{frame}[containsverbatim]
  \frametitle{\texttt{connect} function}
  {\scriptsize
  \begin{verbatim}
    #include <sys/socket.h>
  ...
  \begin{figure}
  \centering
  \includegraphics[width=.8\textwidth]{fig/f-connect-parameters.png}
  \end{figure}
\end{frame}


\begin{frame}[containsverbatim]
  \frametitle{\texttt{bind} function}
  {\scriptsize
  \begin{verbatim}
    #include <sys/socket.h>
  ...
  \begin{figure}
  \centering
  \includegraphics[width=.8\textwidth]{fig/f-bind-parameters.png}
  \end{figure}
\end{frame}


\begin{frame}[containsverbatim]
  \frametitle{\texttt{listen} function}
  {\scriptsize
  \begin{verbatim}
    #include <sys/socket.h>
  ...
  \begin{figure}
  \centering
  \includegraphics[width=.8\textwidth]{fig/f-listen-parameters.png}
  \end{figure}
\end{frame}


\begin{frame}[containsverbatim]
  \frametitle{\texttt{accept} function}
  {\scriptsize
  \begin{verbatim}
    #include <sys/socket.h>
  ...
  \begin{figure}
  \centering
  \includegraphics[width=.8\textwidth]{fig/f-accept-parameters.png}
  \end{figure}
\end{frame}
...
\begin{frame}[containsverbatim]
  ...
  \begin{figure}
  \centering
  \includegraphics[width=.8\textwidth]{fig/f-close-parameters.png}
  \end{figure}
\end{frame}
...
\end{flushright}
only \texttt{execve} is a system call within the kernel and the other five are library functions that call execve.
}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Sockets are normally closed with the standard \texttt{close} function, although another way is the \texttt{shutdown} function.
  \end{itemize}
\end{frame}
